...
---
## MILESTONE addendum (2026-07-11)

With the sweep harness: BF16 aggregate 1242 @ N=24 and 1530 @ N=32 — the >= 1000 aggregate stage gate is met in BF16 (quantized saturates ~845 pending the batched quantized mm). See aggregate-throughput-bench-harness outcome.
